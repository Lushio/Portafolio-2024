...
from .views import home, login, ficha_personal, form_ingreso, ficha_lista, servicio_lista,lista_reg_asis
...
urlpatterns = [
    ...
    path('lista_registro_asis/', lista_reg_asis, name="lista_reg_asis")
